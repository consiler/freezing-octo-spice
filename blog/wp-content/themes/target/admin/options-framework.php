...
function optionsframework_page() {
	...
	?>
	 ...
	 <div id="go_pro">
            ...
            <p>This is a free version of target. Get your own copy of professional version if you need to setup your theme like a website with homepage SLIDER , get PORTFOLIO templates, Shortcodes, FORUM support and much more. <a href="http://antthemes.com/?page_id=27" target="blank">Click Here to Learn More Now</a> </p>
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
            ...
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!' , 'target' ) ); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
