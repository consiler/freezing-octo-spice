...
<div id="social" class="nosl"><span class="social-title"><?php _e( 'Follow', 'evolve' ); ?></span>
...
<div id="social" class="sc"><span class="social-title"><?php _e( 'Follow', 'evolve' ); ?></span><div class="clearfix"></div>
<?php get_template_part('social-buttons', 'header'); ?></div>
