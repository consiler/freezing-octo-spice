...
$template_url = get_template_directory_uri(); 
  ...
  $evl_menu_back_color = evl_get_option('evl_menu_back_color','#1b8c9e');
  $evl_menu_back = evl_get_option('evl_menu_back','dark');
  $evl_custom_main_color = evl_get_option('evl_header_footer_back_color','#556061');
  $evl_main_pattern = evl_get_option('evl_pattern','pattern_2.png');
